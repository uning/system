...
cd  infobright
./install-infobright.sh --datadir=$statdb/data --cachedir=$statdb/cache --config=$statdb/my.cnf --port=3307 --socket=/tmp/mysql3307.sock --user=hotel --group=hotel

cat <<EOT
$statdb/mysql -uroot -P3307 
